...
use Cwd;
use Config;
use Email::Sender::Mouse::Transport::Sendmail;
use File::Spec;
...
SKIP:
{
  ...
  my $path = eval { 
    Email::Sender::Mouse::Transport::Sendmail->_find_sendmail($bin_name) 
  };
  is( $path, $sendmail_bin, "found (fake) sendmail at '$sendmail_bin'" );
}

{
  my $sender = Email::Sender::Mouse::Transport::Sendmail->new({
