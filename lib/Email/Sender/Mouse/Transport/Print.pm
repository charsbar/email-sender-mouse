package Email::Sender::Mouse::Transport::Print;
BEGIN {
  $Email::Sender::Mouse::Transport::Print::VERSION = '0.110001';
}
use Mouse;
...
Email::Sender::Mouse::Transport::Print - print email to a filehandle (like stdout)
