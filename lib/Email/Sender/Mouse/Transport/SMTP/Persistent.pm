package Email::Sender::Mouse::Transport::SMTP::Persistent;
BEGIN {
  $Email::Sender::Mouse::Transport::SMTP::Persistent::VERSION = '0.110001';
}
use Mouse;
extends 'Email::Sender::Mouse::Transport::SMTP';
...
Email::Sender::Mouse::Transport::SMTP::Persistent - an SMTP client that stays online
...
The stock L<Email::Sender::Mouse::Transport::SMTP> reconnects each time it sends a
